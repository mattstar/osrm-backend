...
util::FixedPointCoordinate
getCoordinateFromCompressedRange(util::FixedPointCoordinate current_coordinate,
                                 IteratorType compressed_geometry_begin,
                                 const IteratorType compressed_geometry_end,
                                 const util::FixedPointCoordinate final_coordinate,
                                 const std::vector<extractor::QueryNode> &query_nodes)
{
    const auto extractCoordinateFromNode = [](
        const extractor::QueryNode &node) -> util::FixedPointCoordinate
    {
...
inline util::FixedPointCoordinate
