...
int Storage::Run()
{
    ...
    shared_layout_ptr->SetBlockSize<extractor::TravelMode>(SharedDataLayout::TRAVEL_MODE,
                                                           number_of_original_edges);
    shared_layout_ptr->SetBlockSize<guidance::TurnInstruction>(SharedDataLayout::TURN_INSTRUCTION,
                                                                number_of_original_edges);
    ...
    *checksum_ptr = checksum;
    ...
    guidance::TurnInstruction *turn_instructions_ptr =
        shared_layout_ptr->GetBlockPtr<guidance::TurnInstruction, true>(
